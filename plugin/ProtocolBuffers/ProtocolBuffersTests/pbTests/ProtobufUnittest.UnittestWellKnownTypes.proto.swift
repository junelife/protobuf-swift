...
public extension ProtobufUnittest {
  ...
  final public class TestWellKnownTypes : GeneratedMessage {
    ...
    public fileprivate(set) var typeField:Google.Protobuf.MessageType!
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public var typeField:Google.Protobuf.MessageType! {
           get {
      ...
      fileprivate var typeFieldBuilder_:Google.Protobuf.MessageType.Builder! {
           didSet {
              builderResult.hasTypeField = true
           }
      }
      public func getTypeFieldBuilder() -> Google.Protobuf.MessageType.Builder {
        if typeFieldBuilder_ == nil {
           typeFieldBuilder_ = Google.Protobuf.MessageType.Builder()
           builderResult.typeField = typeFieldBuilder_.getMessage()
           if typeField != nil {
      ...
      @discardableResult
      public func setTypeField(_ value:Google.Protobuf.MessageType!) -> ProtobufUnittest.TestWellKnownTypes.Builder {
        self.typeField = value
        return self
      }
      @discardableResult
      public func mergeTypeField(value:Google.Protobuf.MessageType) throws -> ProtobufUnittest.TestWellKnownTypes.Builder {
        if builderResult.hasTypeField {
          builderResult.typeField = try Google.Protobuf.MessageType.builderWithPrototype(prototype:builderResult.typeField).mergeFrom(other: value).buildPartial()
        } else {
          builderResult.typeField = value
        }
        builderResult.hasTypeField = true
      ...
      override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> ProtobufUnittest.TestWellKnownTypes.Builder {
        ...
        while (true) {
          ...
          case 74:
            let subBuilder:Google.Protobuf.MessageType.Builder = Google.Protobuf.MessageType.Builder()
            if hasTypeField {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> ProtobufUnittest.TestWellKnownTypes.Builder {
        ...
        if let jsonValueTypeField = jsonMap["typeField"] as? Dictionary<String,Any> {
          resultDecodedBuilder.typeField = try Google.Protobuf.MessageType.Builder.decodeToBuilder(jsonMap:jsonValueTypeField).build()
